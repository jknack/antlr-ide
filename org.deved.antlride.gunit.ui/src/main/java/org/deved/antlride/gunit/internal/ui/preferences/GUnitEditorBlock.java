...
public class GUnitEditorBlock extends AbstractConfigurationBlock {
	private boolean smartDisabled = false;
	boolean tabAlwaysIndent = false;

	public GUnitEditorBlock(PreferencePage mainPreferencePage,
	...
	public Control createControl(Composite parent) {
		...
		composite = createSubsection(
				control,
				null,
				GUnitPreferenceMessages.SmartTypingConfigurationBlock_typing);
	...
	private Control createClosePairGroup(Composite composite) {
		...
		label = GUnitPreferenceMessages.SmartTypingConfigurationBlock_closeStrings;
		addCheckBox(composite, label, PreferenceConstants.EDITOR_CLOSE_STRINGS,
				0);

		label = GUnitPreferenceMessages.SmartTypingConfigurationBlock_closeBrackets;
		addCheckBox(composite, label,
				PreferenceConstants.EDITOR_CLOSE_BRACKETS, 0);

		label = GUnitPreferenceMessages.SmartTypingConfigurationBlock_closeBraces;
