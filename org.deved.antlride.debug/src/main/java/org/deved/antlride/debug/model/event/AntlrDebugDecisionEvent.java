...
public class AntlrDebugDecisionEvent extends AntlrDebugEvent {

	private int number;
	
	public AntlrDebugDecisionEvent(AntlrDebugTarget debugTarget,AntlrDebugEventKind eventKind, String... properties) {
