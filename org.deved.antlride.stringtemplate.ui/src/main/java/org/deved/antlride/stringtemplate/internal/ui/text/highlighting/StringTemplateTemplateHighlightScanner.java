...
public class StringTemplateTemplateHighlightScanner extends
		AntlrBaseHighlightScanner {

	private static final String[] TOKENS = {
			StringTemplateUIConstants.SH_TEMPLATE};

	public StringTemplateTemplateHighlightScanner(IColorManager manager,
	...
	protected List<IRule> createRules() {
		setDefaultReturnToken(getToken(StringTemplateUIConstants.SH_TEMPLATE));
		return null;
	}
