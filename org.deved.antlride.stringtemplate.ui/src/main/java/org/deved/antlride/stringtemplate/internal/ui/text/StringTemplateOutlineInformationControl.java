...
public class StringTemplateOutlineInformationControl extends
		ScriptOutlineInformationControl {

	private ITextEditor fEditor;

	public StringTemplateOutlineInformationControl(ITextEditor editor,
			Shell parent, int shellStyle, int treeStyle, String commandId) {
	...
	protected TreeViewer createTreeViewer(Composite parent, int style) {
		...
		AppearanceAwareLabelProvider labelProvider = (AppearanceAwareLabelProvider) treeViewer
				.getLabelProvider();
		labelProvider
				.addLabelDecorator(new StringTemplateOutlineLabelDecorator());
		return treeViewer;
	}
