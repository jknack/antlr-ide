...
public class StringTemplateElementProvider implements IInformationProvider, IInformationProviderExtension {

	private ScriptEditor fEditor;
	private boolean fUseCodeResolve;

	public StringTemplateElementProvider(IEditorPart editor) {
		fUseCodeResolve= false;
		if (editor instanceof ScriptEditor)
			fEditor= (ScriptEditor)editor;
	}

	public StringTemplateElementProvider(IEditorPart editor, boolean useCodeResolve) {
		this(editor);
