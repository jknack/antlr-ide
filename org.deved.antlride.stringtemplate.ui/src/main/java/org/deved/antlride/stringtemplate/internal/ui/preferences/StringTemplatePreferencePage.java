...
public class StringTemplatePreferencePage extends
	...
	protected void setPreferenceStore() {
		PreferencesAdapter preferences = new PreferencesAdapter(
				StringTemplateUI.getDefault().getPluginPreferences());
