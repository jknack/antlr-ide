...
public class AntlrParserGrammarPage extends AntlrDefaultGrammarPage {

	public AntlrParserGrammarPage() {
	}
	...
	protected String getGrammarType() {
		return GrammarType.PARSER.name();
	}
	...
	protected String getPageDescription() {
		return "Created a new parser grammar";
	}
